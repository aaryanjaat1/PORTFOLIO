    ...
    <div className="container mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-2">
          <h2 className="text-2xl font-bold mb-6">ARYAN.</h2>
        ...
        <div>
          <h4 className="font-bold mb-6 uppercase text-xs tracking-widest text-neutral-500">Social</h4>
          <ul className="space-y-4">
            ...
            <li><a href="#" className="text-neutral-400 hover:text-white transition-colors">YouTube</a></li>
          </ul>
        </div>
      </div>
      <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-neutral-900 text-sm text-neutral-600">
        <p>© 2024 Aryan. All rights reserved.</p>
    ...
    <Router>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <a 
          ...
          className="fixed bottom-8 right-8 z-50 w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-black shadow-2xl hover:scale-110 transition-transform active:scale-95 group"
        >
